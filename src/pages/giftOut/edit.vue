...
const validInput = computed(() => {
  return (
    dataSource.value.friendInfo.name
    && dataSource.value.date.value
...
<template>
  <div>
    <div class="m-5">
      <div
        class="grid grid-cols-5 mt-3 justify-items-center gap-2 rounded-2xl bg-white p-4"
      >
      ...
      <div
        v-if="dataSource.friendInfo._id"
        class="mt-3 rounded-2xl bg-white p-1"
      >
        <uv-cell
          title="查看往来记录"
          is-link
