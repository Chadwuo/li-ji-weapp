...
<template>
    <div>
        <div class="m-5">
            <div class="grid grid-cols-5 mt-3 justify-items-center gap-2 rounded-2xl bg-white p-4">
                <div v-for="i in columns" :key="i.name" @click="onSelectIcont(i)">
                    <div class="h-12 w-12 flex rounded-full"
            ...
            <div class="mt-3 rounded-2xl bg-white p-4">
                <uv-form label-position="left" label-width="60">
                    <uv-form-item label="日期" @click="calendarRef.open()">
                        <uv-input v-model="dataSource.date.value" disabled disabled-color="#ffffff" border="none"
                            placeholder="请选择日期" />
                        <template #right>
                    ...
                    <uv-form-item label="亲友">
                        ...
                        <template #right>
                            <div v-show="!dataSource._id" class="i-system-uicons-contacts text-lg text-gray"
                    ...
                    <uv-form-item>
                        <div class="flex space-x-4">
                            ...
                            <div class="w-full">
                                <uv-button type="primary" shape="circle" text="保存" :loading="loading"
                                    :disabled="!validInput" loading-mode="circle" @click="onSubmit" />
                            </div>
                        </div>
                    </uv-form-item>
                </uv-form>
        ...
        <uv-calendars ref="calendarRef" lunar color="#F87171" confirm-color="#F87171" :date="dataSource.date.value"
