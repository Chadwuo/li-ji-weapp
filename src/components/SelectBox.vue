...
<template>
  <view class="uni-combox" :class="border ? '' : 'uni-combox__no-border'">
    ...
    <view class="uni-combox__input-box">
      <input v-model="inputVal" class="uni-combox__input" type="text" :placeholder="placeholder"
             placeholder-class="uni-combox__input-plac" @input="onInput" @focus="onFocus" @blur="onBlur"
      >
